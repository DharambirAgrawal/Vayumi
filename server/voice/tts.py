...
#
# MODEL FILES REQUIRED (download separately):
#   - kokoro-v0_19.onnx (~80MB) — The ONNX model
#   - voices.bin — Voice embeddings file
#   Both must be in project root or path specified in constructor.
#
# CLASS: TTSEngine
#
#   __init__(self, model_path="kokoro-v0_19.onnx", voices_path="voices.bin"):
...
class TTSEngine:
    def __init__(self, model_path: str = "kokoro-v0_19.onnx",
